...
const LeftSide = () => {
  return (
    <motion.div
      className="w-full h-full flex flex-col items-center justify-end gap-4 text-textDark"
      initial={{ x: -100 }}
      animate={{ x: 0 }}
    ...
    >
      <div className="flex flex-col gap-4">
        <a href="https://github.com/Hridey79" target="_blank">
          <span
            className="w-10 h-10 text-xl bg-bodyColor rounded-full inline-flex items-center
